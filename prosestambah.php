...
<head>
    <title>Upload File </title>
        ...
        $query = mysqli_query($koneksi,"insert into tblmahasiswa(nim,nama,jns_kelamin,jurusan,kelas,photo)
        values('$nim','$nama','$jekel','$jurusan','$kelas','$namafile')");
        if($query){
